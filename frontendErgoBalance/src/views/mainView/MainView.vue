...
<template>
  ...
  <section class="mainView__container">
    ...
    <article class="mainView__article">
      ...
      <p>Antalet repetitioner (reps) och sets du gör beror på övningen, din egen kapacitet och dina mål. En bra grundregel är att göra 10-20 repetitioner och 2-3 set. Lyssna på din kropp och anpassa efter vad som känns rätt för dig.</p>
